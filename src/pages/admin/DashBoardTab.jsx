...
const DashBoardTab = () => {
  ...
  const { mode, productList, editHandle, deleteProduct, order, user } = context;
                        ...
                        return (
                          <tbody>
                            ...
                            >
                              ...
                              >
                                {allOrders.paymentsInfo.address}
                              </td>
                              <td
                                className="px-6 py-4 text-black "
                                style={{
                              ...
                              >
                                {allOrders.paymentsInfo.pincode}
                              </td>
                              <td
                                className="px-6 py-4 text-black "
                                style={{
                              ...
                              >
                                {allOrders.paymentsInfo.contact}
                              </td>
                              <td
                                className="px-6 py-4 text-black "
                                style={{
            ...
            <TabPanel>
              <div className="relative overflow-x-auto mb-10">
                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                  ...
                  {user.map((item, index) => {
                    const {date, name, uid, email} = item
                    return (
